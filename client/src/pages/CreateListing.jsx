  ...
  return (
   ...
   <form className='flex flex-col sm:flex-row gap-4'>
    ...
    <div className='flex flex-wrap gap-6'>
      ...
      <div className='flex items-center gap-2'>
        <input type="number" id='reularPrice' min='1' max='10' required
        className='p-3 border border-gray-300 rounded-lg' />
    ...
    <div className='flex flex-col flex-1 gap-4'>
      ...
      <div className='flex gap-4'>
        ...
        <button type='button' 
        disabled={uploading}
        onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded
      ...
      <button className='p-3 bg-blue-700 text-white rounded-lg uppercase
